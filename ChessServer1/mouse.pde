void mouseReleased() {
    ...
    if (firstClick) {
      ...
      if (!(row2 == row1 && col2 == col1)) {
        ...
        if(white && grid[row2][col2] == 'p' && row2 == 0) {
          pawnPromo = true;
          myServer.write(row1 + "," + col1 + "," + row2 + "," + col2 + "," + 0 + "," + 1);
  ...
  if(white && pawnPromo) { 
    if(buttonPressed(boardx + boardWid*17/80, boardy + boardHei*7/16, boardWid*1/8, boardHei*1/8)){
        grid[row2][col2] = 'r';
        pawnPromo = false;
        myServer.write(row2 + "," + col2 + "," + 0 + "," + 0 + "," + 2 + "," + 0);
        itsMyTurn = false;
        firstClick = true;
    }
      ...
      grid[row2][col2] = 'b';
      pawnPromo = false;
      myServer.write(row2 + "," + col2 + "," + 1 + "," + 0 + "," + 2 + "," + 0);
      itsMyTurn = false;
      firstClick = true;
    }
      ...
      grid[row2][col2] = 'n';
      pawnPromo = false;
      myServer.write(row2 + "," + col2 + "," + 2 + "," + 0 + "," + 2 + "," + 0);
      itsMyTurn = false;
      firstClick = true;
    }
      ...
      grid[row2][col2] = 'q';
      pawnPromo = false;
      myServer.write(row2 + "," + col2 + "," + 3 + "," + 0 + "," + 2 + "," + 0);
      itsMyTurn = false;
      firstClick = true;
    }
  }
